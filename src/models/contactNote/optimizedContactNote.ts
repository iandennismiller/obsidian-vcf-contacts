...
import { RelationshipOperations, ParsedRelationship, FrontmatterRelationship, ResolvedContact } from './relationshipOperations';
...
// Re-export types from optimized modules
export type { Gender, ParsedRelationship, FrontmatterRelationship, ResolvedContact };
